...
static inline float calculDistanceCarre(Vec3 pt1,Vec3 pt2){
    return pow(pt1[0]-pt2[0],2)+pow(pt1[1]-pt2[1],2)+pow(pt1[2]-pt2[2],2);
}
bool compareVec3(const Vec3 a, const Vec3 b) {
    // Here, you can define the logic for comparison based on your requirements
    // For example, compare based on the x, y, and z values in order
